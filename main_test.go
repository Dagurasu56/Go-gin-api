...
func TestBuscaAlunoPorCPFHandler(t *testing.T) {
	...
	req, _ := http.NewRequest("GET", "/alunos/cpf/34526776412", nil)
	resposta := httptest.NewRecorder()
	r.ServeHTTP(resposta, req)
...
func TestBuscaAlunoPorIdHandler(t *testing.T) {
	...
	assert.Equal(t, "Dagurasu", alunoMock.Nome, "Os nomes devem ser iguais!")
	assert.Equal(t, "34526776412", alunoMock.CPF)
	assert.Equal(t, "890765431", alunoMock.RG)
	assert.Equal(t, http.StatusOK, resposta.Code)
}
...
func TestEditaUmAlunoHandler(t *testing.T) {
	...
	aluno := models.Aluno{Nome: "Dagurasu", CPF: "34526816412", RG: "010765431"}
